    ...
    <div class="card-pannel grey lighten-5">
        <table class="striped centered table-responsive">
            ...
            <tr>
                ...
                <td><?php echo $listado->valor ?></td>
                <td><?php echo $listado->iva ?></td>
                <td><?php echo $listado->valor_bruto ?></td>
                <td>
                    <a href="edit.php?id<?php echo $listado->id?> & nom<?php echo $listado->nombre?> & po<?php echo $listado->precio_origen?> & vf<?php echo $listado->valor_flete?>">
